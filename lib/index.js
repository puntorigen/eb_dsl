    ...
    run() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (eb_appname != '') {
          ...
          if (errors.length == 0 && _this6.context.x_state.central_config.debug == true) {
      ...
      return _asyncToGenerator(function* () {
        if (!_this8.context.x_state.central_config.componente && _this8.context.x_state.central_config.deploy && _this8.context.x_state.central_config.deploy.indexOf('eb:') != -1) {
          ...
          try {
            ...
            _this8.context.debug('AWS credentials:', aws_ini);
          } catch (err_reading) {} // 
    ...
    codeForModel(model) {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this9.context.x_state.npm['aws-sdk']) {
          var aws_data = {
            accessKeyId: _this9.context.x_state.central_config.aws_access,
            secretAccessKey: _this9.context.x_state.central_config.aws_secret
          };

          if (_this9.context.x_state.central_config.aws_region) {
            aws_data.region = _this9.context.x_state.central_config.aws_region;
          }
  ...
  class eb_dsl extends concepto {
    ...
    onInit() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var _loop = function _loop(_key) {
          // omit special config 'reserved' (aurora,vpc,aws) node keys
          if (!['aurora', 'vpc', 'aws', 'copiar'].includes(_key) && typeof _this.x_state.config_node[_key] === 'object') {
        ...
        if (_this6.x_state.central_config.readme != '') {
          yield* function* () {
            ...
            var _loop2 = function _loop2(key) {
              if (!['aurora', 'vpc', 'aws', 'copiar'].includes(key) && typeof _this6.x_state.config_node[key] === 'object') {
    ...
    createPackageJSON() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this10.x_state.central_config[':keywords']) data.keywords = _this10.x_state.central_config[':keywords'].split(','); // set port and env variables to script _dev

        var set_envs = ["APP_PORT=".concat(_this10.x_state.central_config.port), "CLUSTER=1"];

        var _loop3 = function _loop3(key) {
          if (!['aurora', 'vpc', 'aws', 'copiar'].includes(key) && typeof _this10.x_state.config_node[key] === 'object') {
      ...
      return _asyncToGenerator(function* () {
        ...
        for (var file in express.models) {
          ...
          if (_this17.deploy_module.codeForModel) {
            requires = [...requires, ..._this17.deploy_module.codeForModel(express.models[file])];
