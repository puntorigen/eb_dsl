  ...
  class eb_dsl extends concepto {
    ...
    onInit() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this3.x_state.npm['express-session'] = '*'; // add apicache support (cache per endpoint), node-cache (cache per function)

        _this3.x_state.npm['apicache'] = '*';
        _this3.x_state.npm['node-cache'] = '*';
        _this3.x_state.npm['object-hash'] = '*'; // express protection and related libraries
        ...
        _this3.x_state.npm['request'] = '*'; //this.x_state.npm['wait.for']='*';
    ...
    _writeModelos() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (_this25.x_state.config_node.aurora) {
          ...
          var seq_config = {
            logging: _this25.x_state.central_config.dblog == true ? 'func:logging' : false,
            dialect: 'mysql',
            dialectOptions: {
            ...
            pool: {
              max: _this25.x_state.central_config.pool_max,
              min: 1,
              acquire: 12000,
              idle: 12000,
              evict: 12000
