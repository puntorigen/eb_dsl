  ...
  class eb extends base_deploy {
    ...
    post() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!_this8.context.x_state.central_config.componente && _this8.context.x_state.central_config.deploy && _this8.context.x_state.central_config.deploy.indexOf('eb:') != -1 && _this8.context.x_state.config_node.aws && ci.isCI == false) {
    ...
    pre() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!_this9.context.x_state.central_config.componente && _this9.context.x_state.central_config.deploy && _this9.context.x_state.central_config.deploy.indexOf('eb:') != -1 && ci.isCI == false) {
