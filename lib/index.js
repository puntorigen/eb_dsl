  ...
  **/
  ...
  class eb_dsl extends concepto {
        ...
        if (_this6.x_state.central_config.readme != '') {
          yield* function* () {
            ...
            var _loop2 = function _loop2(key) {
              if (!['aurora', 'vpc', 'aws'].includes(key) && typeof _this6.x_state.config_node[key] === 'object') {
    ...
    createPackageJSON() {
      ...
      return _asyncToGenerator(function* () {
        var data = {
          name: _this10.x_state.central_config.service_name,
          description: _this10.x_state.central_config[':description'],
          main: 'app.js',
          scripts: {
            start: './app',
            _dev: 'nodemon ./app.js',
        ...
        var _loop3 = function _loop3(key) {
          if (!['aurora', 'vpc', 'aws'].includes(key) && typeof _this10.x_state.config_node[key] === 'object') {
    ...
    onEnd() {
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!_this17.errors_found) {
          if (!(yield _this17.deploy_module.deploy()) && !_this17.x_state.central_config.componente) {
            _this17.x_console.outT({
              message: 'Something went wrong deploying, check the console, fix it and run again.',
              color: 'red'
            });
          }
          yield _this17.deploy_module.post();
        }
      })();
    }
      ...
      return _asyncToGenerator(function* () {
        ...
        if (ext == 'js') {
          try {
            ...
            _this18.debug("error: could not format the JS file; trying js-beautify");
    ...
    onCreateFiles(processedNodes) {
      ...
      return _asyncToGenerator(function* () {
        ...
        */
        ...
        yield _this20.createPackageJSON();
